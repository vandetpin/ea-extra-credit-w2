...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = {"edu.mum.ea.controller", "edu.mum.ea.domain",
			"edu.mum.ea.dao", "edu.mum.ea.service" })
@EnableJpaRepositories("edu.mum.ea.dao")
